...
//This endpoint is a boilerplate router for the Data Science API
...
//  */
router.get('/predict/:x1/:x2/:3', authRequired, (req, res, next) => {
...
//  *        description: 'Error making prediction'
//  */
router.get('/viz/:state', authRequired, (req, res, next) => {
